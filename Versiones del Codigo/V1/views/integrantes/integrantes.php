            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="index.php?c=info&a=index" class="nav-link">Información de proyecto</a></li>
                        ...
                        <li class="nav-item cta"><a href="contact.html" class="nav-link" data-toggle="modal" data-target="#modalRequest"><span>Iniciar sesión</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-lg-12 col-md-6 d-flex mb-sm-4 ftco-animate">
                        <div class="staff">
                            ...
                            <div class="info text-center">
                                ...
                                <span class="position">Ingeniero de Sistemas e Ingeniero electrónico y de telecomunicaciones</span>
                                <div class="text">
                                    <p>Con amplios conocimientos de Ingeniería de Software, Big data, redes, diseño web y Programación de Computadores para aplicaciones empresariales con conocimientos en lenguajes de programación. Integro, auto gestionado, con alta capacidad de trabajo en equipo, adaptabilidad, comunicación asertiva, autoaprendizaje y liderazgo. Con intereses en prácticas de calidad de software, desarrollo, redes y analítica de datos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                   <div class="col-lg-12 col-md-6 d-flex mb-sm-4 ftco-animate">
                        <div class="staff">
                            ...
                            <div class="info text-center">
                                ...
                                <span class="position">Ingeniero electrónico y de telecomunicaciones e Ingeniero de Sistemas</span>
                                <div class="text">
                                    <p>Con conocmientos en infraestructura de red, administración de servidores, programación web, apasionado por el deporte. Honesto, integro, con buena capacidad de adaptación y resolución de problemas, autodidacta. Con intereses en la seguridad informatica, desarrollo, infrestructura, IoT y TI.</p>
                                </div>
                            </div>
                        </div>
                    </div>                
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalRequestLabel">INICIO DE SESIÓN</h5>
