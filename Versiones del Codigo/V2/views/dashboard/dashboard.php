    ...
    <body>
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="d-flex align-items-center ms-4 mb-4">
                        ...
                        <div class="ms-3">
                            <form id="p_filtrar" name="p_filtrar" method="POST" action="index.php?c=pacientes&a=guarda">
                                <select class="form-select mb-3" aria-label="menuFiltrado" id="p_filtrado" name="p_filtrado">
                                    <option selected>Abrir este menú de selección...</option>                                    
                                    <?php
                                    foreach ($data["pacientes"] as $dato) {
                                        echo "<option value='3'>" . $dato["p_id"] . "</option>";
                                    }
                                    ?>
                        ...
                        <div class="position-relative ms-2 mb-2">
                            <img src="views/style/images/actualizar.png" alt="" style="width: 40px; height: 40px;">
                            <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                        </div>
                    </div>
                    <div class="navbar-nav w-100">
                        <a href="index.php?c=dashboard&a=index" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Resumen</a>                   
                        <a href="index.php?c=tablas&a=index" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tablas</a>
                        <a href="index.php?c=graficos&a=index" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Graficos</a>       
            ...
            <div class="content">
                ...
                <iframe title="DatosPacientes - Página 1" width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiNDA2ZGY2Y2YtY2EzYy00MTllLWI3MWMtYTMyYWFiZDE3MDY1IiwidCI6IjI0ZjA2M2FhLTkzNjItNGUwZS1iMTA1LTkyOWM4NzhkOTI3YSJ9" frameborder="0" allowFullScreen="true"></iframe>
