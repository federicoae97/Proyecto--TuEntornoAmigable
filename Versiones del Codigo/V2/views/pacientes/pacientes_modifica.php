                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-lg-5">
                                ...
                                <form id="p_nuevo" name="p_nuevo" method="POST" action="index.php?c=pacientes&a=actualizar" autocomplete="off">
                                    <input type="hidden" id="p_id" name="p_id" value="<?php echo $data["p_id"]; ?>"/>
                                    <div class="row mb-3">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data["pacientes"] as $dato) {
                                                ...
                                                echo "<td><a href='index.php?c=pacientes&a=eliminar&id=".$dato["p_id"]."'<i class='fa fa-times'></i></a></td>";
                                                echo "</tr>";
                                            }
                                            ?>                                           
                                        </tbody>
