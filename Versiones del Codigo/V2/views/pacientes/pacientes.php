            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="index.php?c=dashboard&a=index" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Resumen</a>                   
                ...
                <div class="container-fluid pt-4 px-xl-4">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-lg-5">
                                <h6 class="mb-4">INFORMACIÓN DE TERAPIA</h6>
                                <form id="p_senal" name="p_senal" method="POST" action="index.php?c=pacientes&a=guarda" autocomplete="off" enctype="multipart/form-data">
