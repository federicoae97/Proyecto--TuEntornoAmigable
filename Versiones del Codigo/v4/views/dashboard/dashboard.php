        ...
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="index.php?c=dashboard&a=index" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>                   
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">                        
                        <iframe title="DatosPacientes" width="1024" height="804" src="https://app.powerbi.com/view?r=eyJrIjoiNDA2ZGY2Y2YtY2EzYy00MTllLWI3MWMtYTMyYWFiZDE3MDY1IiwidCI6IjI0ZjA2M2FhLTkzNjItNGUwZS1iMTA1LTkyOWM4NzhkOTI3YSJ9&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>               
                    </div>
                </div>
                <!-- Widgets End -->
                <!-- Footer Start -->
