            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="index.php?c=tablas&a=index" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Lista de pacientes</a>       
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data["pacientes"] as $dato) {
                                                ...
                                                echo "<td><a href='index.php?c=tablas&a=eliminar&p_id=".$dato["p_id"]."'<i class='fa fa-times'></i></a></td>";
                                                echo "</tr>";
                                            }
                                            ?>                                           
                                        </tbody>
